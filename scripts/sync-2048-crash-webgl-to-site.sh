...
source_dir="$repo_root/prototypes/2048-crash/Builds/WebGL/2048-crash"
target_dir="$repo_root/web/mannlab-games/public/games/2048-crash"

if [[ ! -f "$source_dir/index.html" ]]; then
  echo "WebGL build not found: $source_dir/index.html" >&2
  echo "Run ./scripts/verify-2048-crash-webgl.sh first." >&2
  exit 2
fi
