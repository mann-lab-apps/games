...
html = html.replace(
  'var buildUrl = "Build";\n      var loaderUrl = buildUrl + "/10000.loader.js";',
  `var buildUrl = "Build";
      var assetVersion = "${assetVersion}";
      var versionSuffix = "?v=" + assetVersion;
      var loaderUrl = buildUrl + "/10000.loader.js" + versionSuffix;`
);
html = html
  .replace('dataUrl: buildUrl + "/10000.data"', 'dataUrl: buildUrl + "/10000.data" + versionSuffix')
  .replace('frameworkUrl: buildUrl + "/10000.framework.js"', 'frameworkUrl: buildUrl + "/10000.framework.js" + versionSuffix')
  .replace('codeUrl: buildUrl + "/10000.wasm"', 'codeUrl: buildUrl + "/10000.wasm" + versionSuffix');
html = html.replace(
