...
build_log="/tmp/gather-and-shot-unity-webgl-build.log"
build_output="$project/Builds/WebGL/gather-and-shot"
missing=0
...
"$unity_editor" \
  ...
  -quit \
  -projectPath "$project" \
  -executeMethod MannLab.Games.GatherAndShot.EditorTools.BuildWebGL.Build \
  -logFile "$build_log"
