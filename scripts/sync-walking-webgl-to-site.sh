...
if [[ -f "$target_dir/index.html" ]]; then
  perl -0pi -e 's/\.data\.gz/.data/g; s/\.framework\.js\.gz/.framework.js/g; s/\.wasm\.gz/.wasm/g; s#(var loaderUrl = buildUrl \+ "/walking\.loader\.js")#$1 + "?v=thumbwaddle-20260831e"#g; s#(dataUrl: buildUrl \+ "/walking\.data")#$1 + "?v=thumbwaddle-20260831e"#g; s#(frameworkUrl: buildUrl \+ "/walking\.framework\.js")#$1 + "?v=thumbwaddle-20260831e"#g; s#(codeUrl: buildUrl \+ "/walking\.wasm")#$1 + "?v=thumbwaddle-20260831e"#g; s/canvas\.style\.width = "960px";/canvas.style.width = "100vw";/g; s/canvas\.style\.height = "600px";/canvas.style.height = "100vh";/g' "$target_dir/index.html"
fi
