...
build_log="/tmp/yacht-rush-unity-webgl-build.log"
build_output="$project/Builds/WebGL/yacht-rush"
missing=0
...
"$unity_editor" \
  ...
  -quit \
  -projectPath "$project" \
  -executeMethod MannLab.Games.YachtRush.EditorTools.BuildWebGL.Build \
  -logFile "$build_log"
