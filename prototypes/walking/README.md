...
- The player sees a small rounded sketch-style mascot body and left/right feet from behind so touch results are readable.
...
- The current MVP space is a broad paper field with sparse soft obstacles, not a maze.
